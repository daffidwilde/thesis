...
Both of the initialisation methods described in the above subsections have a
...
Instead, the proposed method employs the standard form of HR and mitigates the
effect of ties by considering a potentially large number of candidate points (up
to \(k^2\)). Algorithm~\ref{alg:proposed_method} provides a formal statement of
the proposed method.
