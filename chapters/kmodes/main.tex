...
The \(k\)-modes algorithm is stochastic, in that it is dependent on its starting
...
component. Cao's method essentially chooses the densest point that has not
...
be referred to as Cao-preferable. For the sake of computational time, the
...
The latter analysis showed that proposed method should be employed over Cao's if
