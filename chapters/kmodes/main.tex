...
method for the three datasets with which it succeeds; the number of iterations
is comparable; the computation time is substantially less than the other two
