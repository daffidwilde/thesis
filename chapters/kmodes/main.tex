...
are no empty clusters in the first iteration of the algorithm.  However, this
set of points need not be determined entirely at random. The remainder of this
...
matching initialisation method) although the disparity between Cao's method and
the others is significantly less.
