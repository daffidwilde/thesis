...
of the columns of \(X\). This function will be referred to as the `discounted
silhouette' fitness function.
...
\begin{itemize}
    ...
    \item A score of zero still indicates there is little to be gained in that
        ...
        cloud.
    \item Negative scores indicate a dataset with either low-to-negative
        silhouette and high correlation (i.e.\ high inertia but correlated) or
        negative silhouette (i.e.\ the clustering is inappropriate) and
