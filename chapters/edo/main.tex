...
are comprised: the trivial case where the number of rows equals \(k\) has been
omitted; a shorter run time is used to reduce computational resources and
because the EA produces results that are as useful, indicating that a local
optimum has been identified; and, finally, the selective pressure has been
increased to mitigate the effect of noise in later generations.
...
Snippet~\ref{snp:inertia} shows the experiment script used for this example.
Other than the fitness function definition, this script is identical to that of
every example in this section.
...
def fitness(individual, max_seed=5):
    ...
    for seed in range(max_seeds):
        dataframe = MinMaxScaler().fit_transform(
            individual.dataframe, copy=True
        )
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{\imgwidth}
        \includegraphics[width=\linewidth]{kmeans_inertia_small_fitness.pdf}
        \label{fig:kmeans_inertia_small_fitness}
    \end{subfigure}

    \begin{subfigure}{\imgwidth}
        \includegraphics[width=\linewidth]{kmeans_inertia_small_nrows.pdf}
...
\begin{figure}[htbp]
    \centering
    \begin{subfigure}{\imgwidth}
        \includegraphics[width=\linewidth]{kmeans_inertia_large_fitness.pdf}
        \label{fig:kmeans_inertia_large_fitness}
    \end{subfigure}

    \begin{subfigure}{\imgwidth}
        \includegraphics[width=\linewidth]{kmeans_inertia_large_nrows.pdf}
...
\begin{figure}[htbp]
    \centering
    \begin{subfigure}{\imgwidth}
        \includegraphics[width=\linewidth]{kmeans_inertia_small_inds.pdf}
        \caption{with \(R = (3, 100)\)}\label{fig:kmeans_inertia_small_inds}
    \end{subfigure}

    \begin{subfigure}{\imgwidth}
        \includegraphics[width=\linewidth]{kmeans_inertia_large_inds.pdf}
...
\begin{figure}[htbp]
    \centering
    \begin{subfigure}{\imgwidth}
        \includegraphics[width=\linewidth]{kmeans_silhouette_small_fitness.pdf}
        \label{fig:kmeans_silhouette_small_fitness}
    \end{subfigure}

    \begin{subfigure}{\imgwidth}
        \includegraphics[width=\linewidth]{kmeans_silhouette_small_nrows.pdf}
...
\begin{figure}
    \centering
    \begin{subfigure}{\imgwidth}
        \includegraphics[width=\linewidth]{kmeans_silhouette_large_fitness.pdf}
        \label{fig:kmeans_silhouette_large_fitness}
    \end{subfigure}

    \begin{subfigure}{\imgwidth}
        \includegraphics[width=\linewidth]{kmeans_silhouette_large_nrows.pdf}
...
\begin{figure}
    \centering
    \begin{subfigure}{\imgwidth}
        \includegraphics[width=\linewidth]{kmeans_silhouette_small_inds.pdf}
        \caption{with \(R=(3, 100)\)}\label{fig:kmeans_silhouette_small_inds}
    \end{subfigure}

    \begin{subfigure}{\imgwidth}
        \includegraphics[width=\imgwidth]{kmeans_silhouette_large_inds.pdf}
...
\begin{figure}
    \centering
    \begin{subfigure}{\imgwidth}
        \includegraphics[width=\linewidth]{kmeans_over_dbscan_fitness.pdf}
        \label{fig:kmeans_over_dbscan_fitness}
    \end{subfigure}

    \begin{subfigure}{\imgwidth}
        \includegraphics[width=\linewidth]{kmeans_over_dbscan_nrows.pdf}
...
\begin{figure}
    \centering
    \begin{subfigure}{\imgwidth}
        \includegraphics[width=\linewidth]{kmeans_over_dbscan_kmeans_inds.pdf}
        \caption{%
    ...
    \begin{subfigure}{\imgwidth}
        \includegraphics[width=\linewidth]{kmeans_over_dbscan_dbscan_inds.pdf}
...
\begin{figure}[htbp]
    \centering
    \begin{subfigure}{\imgwidth}
        \includegraphics[width=\linewidth]{dbscan_over_kmeans_fitness.pdf}
        \label{fig:dbscan_over_kmeans_fitness}
    \end{subfigure}

    \begin{subfigure}{\imgwidth}
        \includegraphics[width=\linewidth]{dbscan_over_kmeans_nrows.pdf}
...
\begin{figure}
    ...
    \begin{subfigure}{\imgwidth}
        \centering
        \includegraphics[width=\linewidth]{dbscan_over_kmeans_kmeans_inds.pdf}
        \caption{%
            clustered by \(k\)-means
    ...
    \begin{subfigure}{\imgwidth}
        \centering
        \includegraphics[width=\linewidth]{dbscan_over_kmeans_dbscan_inds.pdf}
