...
such metric. The standard silhouette function is used here over that defined
...
clustering found by \(k\)-means and DBSCAN respectively, and let \(Z_D
\subseteq X\) be the clustering by DBSCAN. Then the fitness function is defined
to be:
\begin{equation}
    f(X) =
        \begin{cases}
