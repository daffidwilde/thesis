...
EDO is certainly doing its job of optimising across the search space. However,
...
environment in which individuals exist is more competitive in a sense. Since the
...
% TODO Update these DOIs.
% TODO Move this paragraph up to the top of the section.

% TODO The end of this section needs revising

\section{Conclusion}

This chapter has introduced a novel approach to understanding the quality
