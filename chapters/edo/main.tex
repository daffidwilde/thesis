...
datasets of the same form in less time, indicating the identification of a local
optimum; and, finally, increasing the selective pressure (by reducing \(b\)) to
mitigate the effect of noise in later generations.
...
comfortably into memory is concern then not all of the data must be studied; the
analysis in Chapter~\ref{chp:kmodes}, for instance, only considers the fittest
