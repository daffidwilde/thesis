...
Second World War, OR has been applied in all manner of organisations and
industries, including those relating to logistics, engineering, and
government~\cite{Hillier2005}. Techniques from OR are often designed to optimise
an objective function, which may relate to quantities such as costs or
efficiency, but the overarching purpose of OR is to make sense of a system that
is too complex to understand without a thorough, scientific study of its inner
workings.
...
industrial and organisational complexity. Among the affected industries is
healthcare. With ever-growing issues like increased population size and
densities, longer life expectancy, and broader access to its services,
healthcare has become one of the most morally essential applications of OR.
...
in modern OR projects are increasingly making use of machine learning
techniques.

% TODO paragraphs on:
%   - machine learning as a part of OR
%   - lack of data is a common issue
%   - brief mention of ethics, fair ML and game theory
%   - Cwm Taf and COPD
...
evaluating an algorithm's performance and incorporating game theory into
clustering. In turn, these methods contribute to a novel operational
methodology, which addresses the concerns of \ctmuhb\ and their COPD population,
despite a lack of highly detailed data.

The remainder of this chapter is as follows: Section~\ref{sec:thesis} sets out
the structure of this thesis and its chapters; Section~\ref{sec:questions}
states the primary research questions approached by this thesis as well as
outlining its novel aspects; Section~\ref{sec:dev} provides an overview of the
