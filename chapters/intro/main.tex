...
specialties, but all of the software for this thesis was developed using
...
interact with one another's repositories by reporting issues, commenting and
liking, and (perhaps most importantly) requesting to make changes to a code
base.
