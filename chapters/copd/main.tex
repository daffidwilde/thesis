...
\begin{center}
    ...
    Source code: \doi{10.5281/zenodo.3937548}\\[1em]
...
administrative dataset of patients presenting COPD, and demonstrates how
actionable insights can be identified by thoroughly extracting information from
the dataset.
...
interest to population health research, and to \ctmuhb, as it is
...
Moreover, an internal report by NHS Wales found \ctmuhb\ had
...
February 2011 through to March 2019 totalling 10,861 spells. A patient
...
\begin{figure}
    ...
    \resizebox{!}{.9\textheight}{%
        \input{chapters/copd/tex/process.tex}
    }
    \caption{%
...
this chapter has been archived online under~\doi{10.5281/zenodo.4457902}. Also,
the datasets generated from the simulations in this section, and the parameter
sweep, have been archived online~\doi{10.5281/zenodo.4457808}.
