...
\begin{tikzpicture}
    ...
    \draw[|-latex, ultra thick]
        ([xshift=1em, yshift=-0.5em]p1.east) -- ++(3.5, 0)
        node[midway, above] {Consultation}
        node[pos=1] (p1-consult) {};
    \draw[|-latex, ultra thick] (p1-consult.east) -- ++(2.5, 0)
        node[midway, above] {X-ray}
        node[pos=1] (xray) {};

    \draw[|-latex, ultra thick] ([yshift=-5em]xray.east) -- ++(3, 0)
        node[midway, above] {Physiotherapy};

    \color{orange}
    \draw[|-latex, ultra thick]
        ([xshift=3em, yshift=-0.5em]p3.east) -- ++(3, 0)
        node[midway, above] {Consultation}
        node[pos=1] (p3-consult) {};
    \draw[|-latex, ultra thick] (p3-consult.east) -- ++(2, 0)
        node[midway, above] {MRI} node[pos=1] (mri) {};
    \draw[|-latex, ultra thick] (mri.east) -- ++(3, 0)
