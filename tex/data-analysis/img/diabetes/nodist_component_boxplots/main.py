...
cols = sorted(['SPS', 'SECC', 'RADTH', 'PROS', 'OUTP', 'OTH_OTH', 'OTH',
               'OPTH', 'ENDO', 'EMER', 'CRIT'])

def plot_nodist_component_boxplots(df):
    """
    Grouped boxplots for the cost components which seem to show no significant
    distribution.
    """
